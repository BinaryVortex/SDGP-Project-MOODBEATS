...
const styles = StyleSheet.create({
  ...
  logo: { color: 'white', fontSize: 18, fontWeight: 'bold', marginBottom: 10 },
  searchInput: { backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: 20, padding: 10, color: 'white' },
  ...
  playButton: { backgroundColor: '#FF007F', padding: 10, borderRadius: 20 },
  bottomNav: { flexDirection: 'row', justifyContent: 'space-around', backgroundColor: '#222', paddingVertical: 15 },
  navButton: { alignItems: 'center' },
  navTextActive: { color: '#FF007F', fontSize: 12, marginTop: 5 },
  navText: { color: 'gray', fontSize: 12, marginTop: 5 },
});
